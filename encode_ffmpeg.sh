...
ffmpeg -y -r 30 -framerate 30 -i ./out/vis/step_%04d.ppm -c:v h264_nvenc -b:v 10M -pix_fmt yuv420p -an -sn -dn -g 15 -bf 2 -preset slow -tune hq -profile:v main -rc-lookahead 16383 -spatial_aq 1 -temporal_aq 1 -coder cabac -b_ref_mode middle ${FILENAME} && \
mpv --loop ${FILENAME}
