...
CXX_FLAGS="-flto -fopenmp -march=native -Ofast -pedantic -std=c++17 -Wall -Wextra -Wno-missing-field-initializers -Wno-unused-parameter -Wno-unused-variable" # parameters for Clang
#-g -Og
